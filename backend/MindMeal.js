...
// MYSQL VEZA
const connection = mysql.createConnection({ //Stvaranje veze s bazom fstefanac, te ispis njenih podataka
  host: 'ucka.veleri.hr',
  user: 'fstefanac',
  password: '11',
  database: 'fstefanac',
...
app.get("/api/planovi", (req, res) => {
  ...
  connection.query(query, params, (error, results) => {
    if (error) {
      ...
      return res.status(500).json({ error: "Greška prilikom pretrage planova" });
    }
